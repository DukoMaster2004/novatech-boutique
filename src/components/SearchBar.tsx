  ...
  useEffect(() => {
    ...
    const searchProducts = async () => {
      ...
      try {
        ...
        setMobileSearchResults((data as unknown as Product[]) || []);
      } catch (error) {
    ...
    <>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          {/* Mobile Search Bar - CONECTADO A BD */}
          {isMobileSearchOpen && (
            <div className="lg:hidden pb-3 animate-in fade-in slide-in-from-top-2">
              ...
              {mobileSearchQuery.trim() && (
                <div className="mt-2 bg-background border border-input rounded-lg shadow-lg max-h-80 overflow-y-auto">
                  {isSearching ? (
